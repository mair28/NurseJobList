...
user_pref("app.update.lastUpdateTime.addon-background-update-timer", 1765895839);
user_pref("app.update.lastUpdateTime.browser-cleanup-thumbnails", 1765980509);
user_pref("app.update.lastUpdateTime.region-update-timer", 1765895839);
user_pref("app.update.lastUpdateTime.services-settings-poll-changes", 1765895839);
user_pref("app.update.lastUpdateTime.telemetry_modules_ping", 1765895868);
user_pref("app.update.lastUpdateTime.telemetry_untrustedmodules_ping", 0);
user_pref("app.update.lastUpdateTime.xpi-signature-verification", 1765895839);
...
user_pref("browser.newtabpage.activity-stream.impressionId", "{849d0c50-0d63-4c85-9bfc-53a07c544d91}");
...
user_pref("browser.startup.lastColdStartupCheck", 1765980759);
...
user_pref("captchadetection.lastSubmission", 1765895);
...
user_pref("extensions.formautofill.creditCards.reauth.optout", "MDIEEPgAAAAAAAAAAAAAAAAAAAEwFAYIKoZIhvcNAwcECIY+0qT/VfmTBAizCZa+yvDMGw==");
...
user_pref("extensions.webextensions.uuids", "{\"formautofill@mozilla.org\":\"3efc789e-3021-41c6-b5a3-78d57293a915\",\"pictureinpicture@mozilla.org\":\"70e2baa1-d493-49b1-a30c-d8cd20b2bcc0\",\"screenshots@mozilla.org\":\"33b22f4e-0415-43bb-a61c-db3be081708b\",\"webcompat@mozilla.org\":\"e46f2cc4-830d-4d87-a4ea-b4ae61b2085d\",\"firefox-compact-dark@mozilla.org\":\"e670a7f6-55a5-45f9-958b-ba933cacf9db\",\"addons-search-detection@mozilla.com\":\"a0aeb430-7899-41e9-98a0-037931f86259\",\"uBlock0@raymondhill.net\":\"c6236513-f2ec-4c3f-ac68-3d33d8f361c5\"}");
...
user_pref("intl.accept_languages", "ceb-PH, ceb");
...
user_pref("media.gmp-manager.lastCheck", 1765896251);
user_pref("media.gmp-manager.lastEmptyCheck", 1765896251);
...
user_pref("sanity-test.driver-version", "32.0.22029.9039");
...
user_pref("signon.management.page.os-auth.optout", "MDIEEPgAAAAAAAAAAAAAAAAAAAEwFAYIKoZIhvcNAwcECFLk4SG/AdmsBAjS2D6WnQ6g+Q==");
user_pref("toolkit.startup.last_success", 1765980750);
